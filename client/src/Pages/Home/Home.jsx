        ...
        >
          ...
          <Box display="flex" p={["1px 10px", "1px 4px", "4px 11px"]}>
            ...
            <NavLink to="/treatment">
              <Box>
                <Text fontFamily={"NunitoSanSBoldI"} fontSize={["12px", "12px", "15px"]}>
                  GIÀY NAM
                </Text>
              </Box>
            </NavLink>
          ...
          <Box display="flex" p={["1px 10px", "1px 4px", "4px 11px"]}>
            ...
            <NavLink to="/skin">
              <Box>
                <Text fontFamily={"NunitoSanSBoldI"} fontSize={["12px", "12px", "15px"]}>GIÀY NỮ</Text>
              </Box>
            </NavLink>
          </Box>
          ...
          <Box display="flex" p={["1px 10px", "1px 4px", "4px 11px"]}>
            ...
            <NavLink to="/clean">
              <Box>
                <Text fontFamily={"NunitoSanSBoldI"} fontSize={["12px", "12px", "15px"]}>THỜI TRANG & PHỤ KIỆN</Text>
              </Box>
            </NavLink>
          </Box>
